...
public class MySpringDemo
{
    ...
    {
        JFrame frame= new JFrame("My Spring Demo");
        ...
        JTextField textField= new JTextField("My TextField",15);
        ...
        layout.putConstraint(SpringLayout.EAST,textField,6,SpringLayout.EAST,label);
